...
/**
 * @implements \Cake\Event\EventDispatcherInterface<\ADWS\Utils\Middleware\GlideMiddleware>
 */
class GlideMiddleware implements MiddlewareInterface, EventDispatcherInterface
{
    /**
     * @use \Cake\Event\EventDispatcherTrait<\ADWS\Utils\Middleware\GlideMiddleware>
     */
     ...
     *
     * @param callable(): \League\Glide\Server|array<string, mixed> $config Config array or callable returning a Server instance.
     ...
     *
     * @param \Psr\Http\Message\ServerRequestInterface $request The request.
     * @throws \ADWS\Utils\Exception\SignatureException
     * @return void
     */
     ...
     * @throws \ADWS\Utils\Exception\ResponseException
